...
# Run the delete or expire photos script
python3 -m images_report.delete_or_expire_photos --org="$ORG_ID" --bearer-token="$BEARER_TOKEN" --environment="$ENVIRONMENT" $EXTRA_ARGS