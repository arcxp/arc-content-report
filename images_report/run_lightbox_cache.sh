...
# Optional: allow passing extra arguments to the script
EXTRA_ARGS="$@"

# Run the lightbox cache creation script
python3 -m images_report.create_lightbox_cache --org="$ORG_ID" --bearer-token="$BEARER_TOKEN" --environment="$ENVIRONMENT" $EXTRA_ARGS
