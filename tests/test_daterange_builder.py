...
from daterange_builder import DateRangeBuilder, create_date_ranges_from_tuples
...
class TestDateRangeBuilder:
    ...
    @patch.object(DateRangeBuilder, 'get_total_hits')
    ...
    @patch.object(DateRangeBuilder, 'build_optimal_ranges')
    def test_create_date_ranges_from_tuples(self, mock_build_ranges):
        ...
        result = create_date_ranges_from_tuples(
...
class TestDateRangeBuilderIntegration:
    ...
    def test_build_optimal_ranges_logging(self, caplog):
        ...
        with patch.object(DateRangeBuilder, 'get_total_hits', return_value=5000):
            builder = DateRangeBuilder("test_token", "test_org", "test_website")
